...
public class ManHinhForm extends javax.swing.JFrame {
    ...
    private List<DisplayNhan> listDisplayNhan = new ArrayList<>();
    ...
    private void fillHeaderTable() {
        tblCPU.setModel(dtm);
        String header[] = {"STT", "Mã MÀN HÌNH", "TÊN", "TRẠNG THÁI"};
    ...
    private void showDataTable() {
        listDisplayNhan = lkSe.getAllDisplay();
        dtm = (DefaultTableModel) tblCPU.getModel();
        dtm.setRowCount(0);
        int i = 1;
        for (DisplayNhan x : listDisplayNhan) {
            dtm.addRow(new Object[]{
                i++, x.getId(), x.getTenDisplay(), x.getTrangThai()
            });
        }
    }

    private void showDataTableOff() {
        listDisplayNhan = lkSe.getAllDisplayTT();
    ...
    private void initComponents() {
        ...
        p.addTab("Dislay Đang họat động", jScrollPane1);
        ...
        p.addTab("Display Không hoạt động", jScrollPane2);
        ...
        getContentPane().add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 170, -1, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 230, -1, 60));
        ...
        getContentPane().add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 320, 60, 60));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            DisplayNhan ds = new DisplayNhan(id, ten, tt);
            JOptionPane.showMessageDialog(this, lkSe.insertDisplay(ds));
            showDataTableOff();
            showDataTable();
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, lkSe.deleteDisplay(id));
            showDataTable();
            showDataTableOff();
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            DisplayNhan cpu = new DisplayNhan(id, ten, 1);
            JOptionPane.showMessageDialog(this, lkSe.updateDisplay(cpu, id));
            showDataTableOff();
            showDataTable();
        }
    ...
    private void tblCPUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCPUMouseClicked
        ...
        DisplayNhan c = listDisplayNhan.get(row);
        txtID.setText(c.getId());
        txtTen.setText(c.getTenDisplay());
        radioOnl.setSelected(true);
