...
public class RAMandRom extends javax.swing.JFrame {
    ...
    private void fillHeaderTable() {
        tblCPU.setModel(dtm);
        String header[] = {"STT", "Mã RAM & ROM", "CẤU HÌNH", "TRẠNG THÁI"};
    ...
    private void initComponents() {
        ...
        p.addTab("RAM & ROM Đang họat động", jScrollPane1);
        ...
        p.addTab("RAM & ROM Không hoạt động", jScrollPane2);
        ...
        getContentPane().add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 180, -1, -1));
        ...
        getContentPane().add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 90, -1, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 250, -1, 60));
        ...
        getContentPane().add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 340, 60, 60));
        ...
        jLabel8.setText("Mã Ram and Rom :");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            RamRomNhan cpu = new RamRomNhan(id, ten, tt);
            JOptionPane.showMessageDialog(this, lkSe.insertRR(cpu));
            showDataTableOff();
            showDataTable();
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, lkSe.deleteRR(id));
            showDataTable();
            showDataTableOff();
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        RamRomNhan cpu = new RamRomNhan(id, ten, 1);
        JOptionPane.showMessageDialog(this, lkSe.updateRR(cpu, id));
        showDataTableOff();
        showDataTable();
        }
    ...
    private void btnRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshActionPerformed
        ...
        String ten = txtTen.getText();
        if(id.isEmpty()){
            JOptionPane.showMessageDialog(this, "Khôing để trống mã");
        }else{
        RamRomNhan cpu = new RamRomNhan(id, ten, 1);
        JOptionPane.showMessageDialog(this, lkSe.updateRR(cpu, id));
        showDataTableOff();
    ...
    private void tblCPUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCPUMouseClicked
        ...
        RamRomNhan c = listRR.get(row);
        txtID.setText(c.getIdRR());
        txtTen.setText(c.getTenRR());
        radioOnl.setSelected(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RAMandRom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
