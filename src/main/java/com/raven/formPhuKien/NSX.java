...
import services.impl.NhaSanXuatSeImpls;
...
public class NSX extends javax.swing.JFrame {
    ...
    private NhaSanXuatSe nsxSe = new NhaSanXuatSeImpls();
    ...
    private void fillHeaderTable() {
        tblCPU.setModel(dtm);
        String header[] = {"STT", "Mã NSX", "TÊN", "TRẠNG THÁI"};
    ...
    private void initComponents() {
        ...
        p.addTab("Nhà Sản Xuất Đang họat động", jScrollPane1);
        ...
        p.addTab("Nhà Sản Xuất Không hoạt động", jScrollPane2);
        ...
        getContentPane().add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 190, -1, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 260, -1, 60));
        ...
        getContentPane().add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 340, 60, 60));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            ThongKeNSX cpu = new ThongKeNSX(id, ten, tt);
            JOptionPane.showMessageDialog(this, nsxSe.insert(cpu));
            showDataTableOff();
            showDataTable();
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, nsxSe.delete(id));
            showDataTable();
            showDataTableOff();
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            ThongKeNSX cpu = new ThongKeNSX(id, ten, 1);
            JOptionPane.showMessageDialog(this, nsxSe.update(cpu, id));
            showDataTableOff();
            showDataTable();
        }
    ...
    private void tblCPUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCPUMouseClicked
        ...
        ThongKeNSX c = listNSX.get(row);
        txtID.setText(c.getIdNSX());
        txtTen.setText(c.getTenNSX());
        radioOnl.setSelected(true);
