...
public class CPUForm extends javax.swing.JFrame {
    ...
    private void fillHeaderTable() {
        tblCPU.setModel(dtm);
        String header[] = {"STT", "Mã CPU", "TÊN", "TRẠNG THÁI"};
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 190, -1, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 260, -1, 60));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            CPUNhan cpu = new CPUNhan(id, ten, tt);
            JOptionPane.showMessageDialog(this, lkSe.insertCPU(cpu));
            showDataTableOff();
            showDataTable();
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, lkSe.deleteCPU(id));
            showDataTable();
            showDataTableOff();
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            CPUNhan cpu = new CPUNhan(id, ten, 1);
            JOptionPane.showMessageDialog(this, lkSe.updateCPU(cpu, id));
            showDataTableOff();
            showDataTable();
        }
    ...
    private void tblCPUMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCPUMouseClicked
        ...
        CPUNhan c = listCPU.get(row);
        txtID.setText(c.getIdCPU());
        txtTen.setText(c.getTenCPU());
        radioOnl.setSelected(true);
